...
const en: Translations = {
    ...
    incidentLinks: 'Platform Details',
    incidentLinksDesc: 'Please provide the platform name, username, or link where it happened.',
...
const ta: Translations = {
    ...
    incidentLinks: 'தள விவரங்கள்',
    incidentLinksDesc: 'சம்பவம் நடந்த தளத்தின் பெயர், பயனர் பெயர் அல்லது இணைப்பை வழங்கவும்.',
...
const hi: Translations = {
    ...
    incidentLinks: 'प्लेटफ़ॉर्म विवरण',
    incidentLinksDesc: 'कृपया प्लेटफ़ॉर्म का नाम, उपयोगकर्ता नाम या लिंक प्रदान करें जहाँ यह हुआ है।',
