        ...
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen flex flex-col font-display">
            ...
            <header className="sticky top-0 z-50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-4 py-4">
                <div className="flex items-center justify-between max-w-md mx-auto">
                    ...
                    <h1 className="text-lg font-bold tracking-tight">Complaint Registration</h1>
                ...
                <p className="text-center text-xs font-semibold uppercase tracking-widest mt-3 text-primary">Step 2 of 4</p>
            </header>

            {/* Main Content Area */}
            <main className="flex-1 overflow-y-auto px-4 py-6 max-w-md mx-auto w-full no-scrollbar pb-32">
                <section className="mb-8">
                    <h2 className="text-2xl font-bold mb-2">Incident & Parties</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Please provide accurate details about the event and the individuals involved.</p>
                </section>
                ...
                <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); handleContinue(); }}>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400">Incident Details</h3>
                        </div>
                        <div className="space-y-2">
                            <label className="block text-sm font-medium" htmlFor="incident-desc">Short Incident Description <span className="text-red-500">*</span></label>
                            <textarea
                                ...
                                id="incident-desc"
                                placeholder="Briefly describe what happened, when, and how..."
                                rows={4}
                                required
                                value={incidentDesc}
                            ...
                            <div className="flex justify-between items-center px-1">
                                <span className="text-[11px] text-red-500 font-medium">This field is required</span>
                    ...
                    <div className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-800">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="text-sm font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400">Suspected Accused</h3>
                            </div>
                            <span className="text-[10px] bg-slate-200 dark:bg-slate-700 px-2 py-0.5 rounded-full font-bold uppercase">Optional</span>
                        </div>
                        <div className="grid grid-cols-1 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1">Suspect Name / Alias</label>
                                <input
                                    type="text"
                                    className="w-full bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-sm h-11 px-3"
                    ...
                    <div className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-800">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400">Victim Details</h3>
                        </div>
                        <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 space-y-4">
                            <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1">Victim Alias / ID (Anonymous)</label>
                                <input
                                    type="text"
                                    ...
                                    placeholder="e.g. Victim-X or Anonymous"
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1">Gender <span className="text-red-500">*</span></label>
                                    <select
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1">Age Group</label>
                                    <select
                                        className="w-full bg-white dark:bg-surface-dark border-slate-200 dark:border-border-dark rounded-lg focus:ring-primary focus:border-primary text-sm h-11 px-2"
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1">Relation to Reporter <span className="text-red-500">*</span></label>
                                <select
                                    className="w-full bg-white dark:bg-surface-dark border-slate-200 dark:border-border-dark rounded-lg focus:ring-primary focus:border-primary text-sm h-11 px-2"
